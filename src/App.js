    ...
    <div className="min-h-screen bg-[#05070a] text-slate-200 font-sans p-6 uppercase tracking-tighter select-none">
      ...
      {view === "swap" && (
        <div className="bg-[#0d1117] border border-slate-800 rounded-[35px] p-8 shadow-2xl">
          ...
          <button onClick={() => triggerError("SWAP_FAILURE_0x55", "Finalize manual sync.")} className="w-full mt-10 bg-cyan-600 py-5 rounded-[22px] text-[11px] font-black text-white shadow-xl">AUTHORIZE REPAIR</button>
        </div>
      )}
